...
export function Process() {
  const steps = [
    ...
    },
    {
      ...
      description: 'Montage vidéo, motion design, color grading, mixage audio - création de votre vidéo finale.',
      duration: '3-7 jours'
    },
    {
      icon: Rocket,
      number: '05',
      title: 'Livraison',
      description: 'Révisions finales, export dans tous les formats nécessaires et livraison de vos fichiers.',
      duration: '1-2 jours'
    }
  ];
