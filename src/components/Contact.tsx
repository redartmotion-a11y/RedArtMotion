...
export function Contact() {
  const handleWhatsApp = () => {
    ...
    const message = `
📩 *Demande de rendez-vous - RedArtMotion*
...
Cordialement,
    ...
    // Direct Gmail compose URL (opens in new tab)
    ...
    <section id="contact" className="py-16 sm:py-24 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <h2 className="text-white mb-4 text-3xl sm:text-4xl">contact-nous</h2>
        ...
        >
          ...
          >
            ...
            <span> contact nous sur WhatsApp</span>
